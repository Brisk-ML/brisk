...
![Documentation Status](https://docs.briskml.org/projects/brisk/badge/?version=latest)
...
## New to Brisk?
The [documentation](https://docs.briskml.org/en/latest/) is the best place to 
start.The [Quick Start Guide](https://docs.briskml.org/en/latest/getting_started/quickstart/index.html) will walk you through a simple project to learn the basics.
...
See the [installation](https://docs.briskml.org/en/latest/getting_started/quickstart/install.html) page for more information.


## Contributing

See the [contributing](https://docs.briskml.org/en/latest/dev/contribute.html) page for more information.
